...
# Adaptive Trainings-App mit Streamlit + Intervals.icu API ohne Coach-Modus (direkter Zugriff)
...
if st.sidebar.button("Test starten") and api_key_test:
    r = session.get("https://intervals.icu/api/v1/athlete", auth=("API_KEY", api_key_test))
