...
# Adaptive Trainings-App mit Streamlit + Intervals.icu API – Header-Auth, ohne Username-Abfrage (eigene Daten)
...
if st.sidebar.button("Test starten") and api_key_test:
    ...
    r = session.get("https://intervals.icu/api/v1/athlete", headers=headers)
